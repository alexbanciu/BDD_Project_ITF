Feature: Test the search functionality in the homepage of ebay
  ...
  Scenario:  Check that the user can make an advanced search for a product
    ...
    And Advanced search page: I type Pampers in the enter keyword textbox
    * Advanced search page: I select Exact words exact order from keyword options
    * Advanced search page: I choose Baby from the category list
